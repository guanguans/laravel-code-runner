...
<body>
    <div class="container-fluid">
        <div class="position-fixed end-0 top-0 p-3">
            <div id="toast" class="toast align-items-center bg-danger text-white border-0" role="alert"
        ...
        <div class="row g-0">
            <div class="col-6">
                ...
                <textarea id="code" class="form-control code-show" placeholder="{{ __('code') }}" is="highlighted-code"
                    language="php" tab-size="4"></textarea>
            </div>
            <div class="col-6">
                <label class="form-label" for="result"></label>
                <div class="form-control code-show overflow-auto">
        ...
        <div class="row mt-3">
            <div class="col-4">
                <button type="submit" class="form-control btn btn-success"
                    onclick="runCode('all')">{{ __('run') }}</button>
            </div>
            <div class="col-4">
                <button type="submit" class="form-control btn btn-success"
            ...
            <div class="col-4">
                <button type="submit" class="form-control btn btn-success"
                    onclick="clearCode()">{{ __('clear') }}</button>
            </div>
        </div>
    </div>
